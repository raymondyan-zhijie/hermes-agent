...
def _requires_bearer_auth(base_url: str | None) -> bool:
    ...
    Foundry's Anthropic-style endpoint, and Volcengine Ark's coding plan
    endpoint follow this pattern.
    """
    normalized = _normalize_base_url_text(base_url)
    if not normalized:
        return False
    ...
    return (
        ...
        or normalized.startswith("https://ark.cn-beijing.volces.com")
    )
